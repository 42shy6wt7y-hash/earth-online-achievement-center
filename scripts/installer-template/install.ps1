...
$installRoot = Join-Path $env:LOCALAPPDATA "Programs\EarthOnlineAchievementCenter"
$dataRoot = Join-Path $env:LOCALAPPDATA "EarthOnlineAchievementCenter"
...
$launcher = Join-Path $installRoot "launch-earth-online-achievement-center.ps1"
