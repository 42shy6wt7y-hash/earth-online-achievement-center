    ...
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            try
            {
                ...
                string installRoot = Path.Combine(localAppData, "Programs", "EarthOnlineAchievementCenter");
                string dataRoot = Path.Combine(localAppData, "EarthOnlineAchievementCenter");
                ...
                string launcher = Path.Combine(installRoot, "launch-earth-online-achievement-center.ps1");
